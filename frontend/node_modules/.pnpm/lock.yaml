...
devDependencies:
  aptos-cli:
    specifier: git+https://github.com/briungri/aptos-cli.git
    version: github.com/briungri/aptos-cli/581a64246dba082c6f22d044ab43a96381722cb0
...
packages:
  ...
  /@aptos-labs/wallet-adapter-react@1.3.2:
    resolution: {integrity: sha512-aZ1tfzD5Gp56zpjhgBWHgWUd45FN6V6/NiZ9ClFuCJE+gEw/3R6ezGwjuXAMEEKdFarBSY3qMQDXzInLa+lFDg==}
    dependencies:
      '@aptos-labs/wallet-adapter-core': 2.5.1
      react: 18.2.0
    transitivePeerDependencies:
  ...
  /aptos@1.15.0:
    resolution: {integrity: sha512-cTQX8CpD1RijRc5K9KNypkgK513Wnk9uXmcvPk2neBBq464BHS53ejxx5FeGdPa7LpdDW2oSE6vvyzU8xJBvCg==}
    engines: {node: '>=11.0.0'}
    dependencies:
      '@aptos-labs/aptos-client': 0.0.2
      '@noble/hashes': 1.1.3
  ...
  github.com/briungri/aptos-cli/581a64246dba082c6f22d044ab43a96381722cb0:
    resolution: {tarball: https://codeload.github.com/briungri/aptos-cli/tar.gz/581a64246dba082c6f22d044ab43a96381722cb0}
    name: '@brian-aptos/aptos-cli'
    version: 2.0.2
    hasBin: true
    dev: true
